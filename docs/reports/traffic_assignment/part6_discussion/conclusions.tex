...
\input{traffic_assignment/preserved/101_3047_3058_discussion.tex}
...
stated timetable, routing, production, destination-attractiveness baseline and
correction (Section~\ref{sec:destination-attractiveness}), likelihood, and prior
