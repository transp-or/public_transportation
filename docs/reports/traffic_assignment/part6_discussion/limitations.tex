...
travel-time and transfer summaries, destination-attractiveness baselines and
corrections (Section~\ref{sec:destination-attractiveness}), and journey
...
The laptop-scale fixed-routing workflow depends jointly on bounded timetable
preprocessing, reuse of fixed responses, and parameter reduction. No single
preprocessing representation removes the cost of exhaustive response
construction or an unnecessarily large response representation.
