...
\hline
Chunk & Calls & Compile (s) & Build (s) & Host peak (MiB) & Warm value--gradient (s) \\
\hline
128  & 184 & 0.133 & 107.168 & 10.43 & 0.000823 \\
256  & 124 & 0.136 & 73.982  & 10.39 & 0.000804 \\
512  & 113 & 0.132 & 66.657  & 10.39 & --- \\
1024 & 113 & 0.139 & 66.574  & 10.39 & 0.000808 \\
2048 & 113 & 0.135 & 66.894  & 10.40 & 0.000806 \\
\hline
\end{tabular}
...
At chunk size 1024, device synchronization accounted for 65.113 s of the
66.574 s construction; NumPy transfer took only 0.0062 s and compilation
occurred exactly once. Relative to a 1.94 s reference evaluation, the measured
construction break-even is approximately 34.3 evaluations. A cache-seeding
process required 110.65 s for complete MAP-problem construction, while fresh
processes loading the persistent cache required 0.70--0.74 s.
...
\hline
1  & 4  & 8.543  & 0.477 & $17.9\times$ & 0.0039 \\
5  & 8  & 18.551 & 2.948 & $6.3\times$  & 0.0000 \\
20 & 24 & 52.648 & 5.679 & $9.3\times$  & 0.0039 \\
\hline
\end{tabular}
\caption{Fresh-process TPG optimizer timings from the unchanged profiling
harness. Compilation is reported separately by that harness. Warm cached BCOO
value-and-gradient time was 0.000784--0.000841 s, versus 1.868--1.954 s for the
fixed-routing loader.}
