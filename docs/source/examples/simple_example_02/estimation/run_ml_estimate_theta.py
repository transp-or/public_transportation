"""
Maximum-likelihood estimation with theta estimated.

Reads ../data and ../pre_processing/results. Writes results/ml_estimated_theta_results.npz.
"""
...
def main() -> None:
    ...
    with prepare_scenario_folder() as scenario_dir:
        ...
        out_path = RESULTS / "ml_estimated_theta_results.npz"
        np.savez_compressed(
            out_path,
            fingerprint=str(idm.fingerprint),
            fingerprint_payload_json=idm.fingerprint_payload_json,
