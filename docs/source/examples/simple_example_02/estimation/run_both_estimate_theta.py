"""
Bayesian VI and ML comparison with theta estimated.

Reads ../data and ../pre_processing/results. Writes results/compare_vi_ml_estimated_theta_results.npz.
"""
...
def main() -> None:
    ...
    with prepare_scenario_folder() as scenario_dir:
        ...
        out_path = RESULTS / "compare_vi_ml_estimated_theta_results.npz"
        np.savez_compressed(
            out_path,
            fingerprint=str(idm.fingerprint),
            fingerprint_payload_json=idm.fingerprint_payload_json,
